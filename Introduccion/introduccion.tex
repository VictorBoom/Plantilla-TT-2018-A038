...
Explicar que es una enfermedad
	Que tipos de enfermedades existen
		Como se combaten las enfermedades
			Que es un medicamento
				Que tipos de medicamentos hay
					Que relevancia hay en los tratamientos
...
\begin{itemize}
	\item RecuerdaMed: Esta app está pensada para posibilitar al paciente, o a la persona que lo cuida, llevar un control exhaustivo de su medicación, para contrastarla, y corregirla si es necesario, con los profesionales sanitarios.
	\item Dosecast: Dosecast es la aplicación de administración de medicamentos más flexible y fácil de usar disponible para dispositivos Apple, Android y Amazon. Con Dosecast, recordarás tomar la medicación correcta, de la manera correcta, en el momento correcto, pero solo para su versión premium.
	\item Medisafe: La medicación que no se usa en el gabinete no sirve de nada, desde el paciente olvidadizo, el farmacéutico, el médico que receta y la farmacéutica que lo desarrolló. Medisafe es una solución completa de continuidad de atención que brinda tranquilidad a millones de usuarios y ayuda a resolver el problema de incumplimiento de la medicación.
	\item PillManager: La aplicación PillManager está disponible para teléfonos móviles basados en iOS y Android, así como en la web, y sirve como un recordatorio de dosificación de medicamentos (excepto la versión web donde los recordatorios no se pueden activar) y una herramienta de reordenación portátil. La aplicación fue creada para atraer a una amplia gama de personas que desean combinar el seguimiento de medicamentos líder en la industria y un sistema de gestión de la salud con el primer sistema de recarga de recetas completamente integrado de la aplicación en el mundo.
	\item PharApp: Pharapp+ impulsa la adherencia del paciente al tratamiento farmacológico prescrito con independencia del tipo de medicamento y su forma de administración, facilitando la atención farmacéutica a través del SPD y las nuevas tecnologías: e-SPD. 
	\item Capzule: Aplicación única para seguir la salud y el bienestar de su familia
	\item Andaman7: Andaman7 facilita la administración de sus datos de salud. Tú tienes el control. No hay datos de salud en la nube.
	\item GenieMD: Primera plataforma de telemedicina totalmente funcional, basada en la nube y móvil, que incluye directrices algorítmicas basadas en la evidencia, videoconferencia, mensajes de texto seguros, procesamiento de pagos, administración de atención crónica y mucho más.
\end{itemize}
