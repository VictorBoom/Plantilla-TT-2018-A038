\begin{UseCase}{CUR 20}{Eliminar Auxiliar}
    {
...
\begin{UCtrayectoria}
	...
	\UCpaso [\UCactor] Presiona el ícono \textbf{Eliminar Auxiliar} asociado al Auxiliar que desea eliminar en la pantalla \textbf{Auxiliares}.
	\UCpaso Muestra el mensaje \cdtIdRef{MSG}{Eliminar Elemento} en la pantalla \textbf{Auxiliares}.
	\UCpaso [\UCactor] Confirma eliminar el auxiliar a través del botón \textbf{Eliminar}.
...
\begin{UCtrayectoriaA}{A}{El actor desea cancelar la operación.}
	...
	\UCpaso Muestra a la pantalla \textbf{Auxiliares}.
\end{UCtrayectoriaA}
