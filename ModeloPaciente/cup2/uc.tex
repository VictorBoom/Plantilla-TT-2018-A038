\begin{UseCase}{CUR 2}{Recuperar contraseña}
    {
    	...
    	Cuando un usuario de la aplicación no es capaz de ingresar al sistema por que olvido su contraseña o no ingresa la contraseña correcta el sistema recuperara su la contraseña de su usuario para que este se pueda logear en el sistema.
...
%--------------------------------------------------------
	...
	\UCitem{Salidas}{\cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Recuperar contraseña} cuando se mando el correo para recuperar la contraseña.}
	...
	\UCitem{Errores}{
		...
		\UCli \cdtIdRef{MSG4}{correo electrónico no existente}: Se muestra en la pantalla 
		Se muestra en la pantalla \textbf{Recuperar contraseña} indicando que el correo electrónico ingresado no existe.
