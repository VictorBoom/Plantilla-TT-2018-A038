\begin{UseCase}{CUR 14}{Consultar Doctor}
    {
    	Este caso de uso permite al \textbf{Paciente} consultar los doctores que tiene asociados a su cuenta y a la vez, consultar a qué tratamiento está asociado cada doctor.
...
%--------------------------------------------------------
	...
	{\bf Interna:} El actor podrá consultar la información de los doctores asociados a su cuenta.
	}
 ...
 \begin{UCtrayectoria}
	 ...
	 \UCpaso [\UCactor] Da click sobre el icono \textbf{Doctores} en la pantalla \textbf{Menu Principal}.
	 
	 \UCpaso Muestra la pantalla \textbf{Doctor}.
	 
	 \UCpaso [\UCactor] Da click sobre el icono \textbf{Consultar Doctor} en la pantalla \textbf{Doctor}.
	 
	 \UCpaso  Muestra la pantalla \textbf{Doctores}.\refTray{A}
	 
	 \UCpaso [\UCactor] Da clic en el botón \textbf{Regresar}.
	 
	 \UCpaso Muestra la pantalla Doctor.
	 
   
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}{A}{El actor no tiene doctores asociados a su cuenta.}
    \UCpaso Muestra el mensaje \cdtIdRef{MSG}{No hay doctores} en la pantalla \textbf{Doctor}.
   \UCpaso [\UCactor] Presiona el botón \cdtButton{Aceptar} del mensaje {MSG} {No hay Doctor}.
...
{\cdtIdRef{CUR 12}{Agregar Doctor}}
