\begin{UseCase}{CUR 13}{Eliminar Doctor}
    {
...
%--------------------------------------------------------
	...
	\UCitem{Precondiciones}{
		{\bf Interna:} El doctor debe estar registrado en el sistema.
		}
	\UCitem{Postcondiciones}{
	    {\bf Interna:} Los tratamientos de los cuales el doctor era el responsable, pasaran a estado \textbf{Incompleto}.	
	}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso Muestra la pantalla \textbf{Consulta de doctores}. \label{cancelar}
 	\UCpaso [\UCactor] Presiona el icono \textbf{Eliminar}.
 	\UCpaso Muestra el mensaje \textbf{MSGX}{Eliminar Doctor}.
 	\UCpaso [\UCactor] Presiona el botón \cdtButton{Eliminar}.\refTray{A}
 	\UCpaso Muestra el mensaje \textbf{MSGX}{Tratamiento pasaran a estado incompleto}
 	\UCpaso [\UCactor] Presiona el botón \cdtButton{Aceptar}.\refTray{A}
 	\UCpaso Pasa los tratamientos que tenia el doctor a su cargo a estado \textbf{Incompleto}
 	\UCpaso Elimina al doctor de la lista de doctores del paciente.
 	\UCpaso Muestra el mensaje \textbf{MSG1}{Operacion correcta} en la pantalla \textbf{Consultar Doctor} 	
