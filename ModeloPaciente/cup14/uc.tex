\begin{UseCase}{CUP14}{Eliminar Doctor}
    {
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Eliminar Doctor.}
	\UCitem{Entradas}{
        Ninguna
   }
	\UCitem{Salidas}{Ninguna.}
	\UCitem{Precondiciones}{
		{\bf Interna:} El doctor debe estár registrado en el sistema.
		}
	\UCitem{Postcondiciones}{
	    {\bf Interna:} Los tratamientos de los cuales el doctor era el responsable, pasarán a estado \textbf{Incompleto}.	
	}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP15}{Consultar Doctor}. \label{cancelar}
 	...
 	\UCpaso Muestra el mensaje \textbf{MSG1}{Operacion correcta} en la pantalla \cdtIdRef{IUP15}{Consultar Doctor}.	
