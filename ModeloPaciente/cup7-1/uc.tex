\begin{UseCase}{CUR 7}{Consultar Información de Tratamiento}
    {
    	Este caso de uso permite al \textbf{Paciente} consultar los tratamientos que ha registrado en la aplicación.
    }
    \UCitem{Versión}{1.0}
...
%--------------------------------------------------------
	...
	\UCitem{Precondiciones}{{\bf Interna:} Tratamientos registrados en el sistema.}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Oprime el icono \textbf{Tratamientos} de la pantalla \textbf{Menú Principal}.
 	\UCpaso Muestra la pantalla \textbf{Tratamientos}.
 	\UCpaso [\UCactor] Oprime el icono \textbf{Consultar Tratamiento} de la pantalla \textbf{Tratamientos}.
 	\UCpaso Ordena los tratamientos tomando en cuenta el número del tratamiento.
 	\UCpaso Muestra la pantalla \textbf{Tratamientos}.
 	\UCpaso [\UCactor] Selecciona el tratamiento que deseas consultar su información.
 	...
 	\UCpaso	Muestra la pantalla \textbf{Tratamiento}.
 	\UCpaso [\UCactor] Consulta la información del tratamiento seleccionado.
 	\UCpaso [\UCactor] Da clic en el botón \textbf{Regresar.}
 	\UCpaso Muestra la pantalla \textbf{Tratamientos}.
 	    
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}{A}{El actor no tiene tratamientos registrados en su cuenta.}
	\UCpaso Muestra el mensaje \cdtIdRef{MSG}{No hay tratamientos} en la pantalla \textbf{Tratamientos}.
	\UCpaso [\UCactor] Presiona el botón \cdtButton{Aceptar} del mensaje {MSG} {No hay contactos tratamientos}.
...
\UCExtensionPoint
{El actor requiere editar su tratamiento}
{ Paso \ref{cur1:Acciones} de la trayectoria principal}
{\cdtIdRef{CUR 8}{Editar Tratamiento}}
