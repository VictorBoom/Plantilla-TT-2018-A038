\begin{UseCase}{CUP17}{Mandar Alerta}
    {
    	Cuando la ingesta de un medicamento se clasifica como importante ya que la ausencia de ésta podría causar daños en la salud del paciente, se mandará una alerta a sus contactos de emergencia, notificando que el paciente no ha ingerido el medicamento.
    ...
    \UCitem{Operación}{Mandar Alerta}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Mandar Alerta.}
	\UCitem{Entradas}{
		Ninguna.
        }
	\UCitem{Salidas}{Ninguna.}
	\UCitem{Precondiciones}{
		{\bf Interna:} El medicamento tiene que tener una clasificación \textbf{Importante}.
		}
    ...
    \UCitem{Reglas de negocio}{
            ...
            \cdtIdRef{RN8}{Medicamento con clasificación}: Verifica que la medicina cuenta con una clasificación\textbf{Importante}.
            
    }
	\UCitem{Mensajes}{
	    \begin{UClist}

		\UCli \cdtIdRef{MSG20}{Aviso a contacto de emergencia}.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso Verifica que el medicamento del recordatorio cuente con una clasificación \textbf{Importante}.
 	
 	\UCpaso Verifica que la notificación haya sido aplazada mas de media hora.
 	
 	\UCpaso Manda una alerta a sus contactos de emergencia.
 	
 	\UCpaso Muestra el mensaje \textbf{MSG20}{Aviso a contacto de emergencia}.
