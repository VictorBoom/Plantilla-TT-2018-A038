\begin{UseCase}{CUR 16}{Mandar Alerta}
    {
    	Cuando la ingesta de un medicamento se clasifica como importante ya que la ausencia de esta podría causar daños en la salud del paciente, se mandara una alerta a sus contactos de emergencia, notificando que el paciente no ha ingerido el medicamento
...
%--------------------------------------------------------
    ...
    \UCitem{Reglas de negocio}{
            ...
            \cdtIdRef{RNX}{Medicamento con clasificación}: Verifica que la medicina cuenta con una clasificación\textbf{Importante}.
            
    }
	\UCitem{Errores}{
	    \begin{UClist}

		\UCli \cdtIdRef{MSGX}{Aviso a contacto de emergencia}.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso Manda una alarma a sus contactos de emergencia.
 	
 	\UCpaso Muestra el mensaje \textbf{MSGX}{Aviso a contacto de emergencia}.
