\begin{UseCase}{CUR 7}{Consultar Información de Tratamiento}
    {
    	Un paciente podra consultar la informacion de un tratamiento que se encuentre en estado activo, en donde se mostrara el doctor que lo expidió, la fecha en que se expidió, el estado y una vista de las semanas en que ese tratamiento ha estado en función.
    }
    \UCitem{Versión}{1.0}
...
%--------------------------------------------------------
	...
	\UCitem{Precondiciones}{
		{\bf Interna:} Que exista el tratamiento al que se esta accediendo.
		{\bf Interna:} Que el tratamiento al que se esta accediendo este en estado activo.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Selecciona un \textbf{Tratamiento} con estado \textbf{Activo} de la pantalla \textbf{Consulta Tratamientos}.
 	...
 	\UCpaso	Muestra la pantalla \textbf{Consultar información de Tratamiento}.
