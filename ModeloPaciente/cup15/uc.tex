\begin{UseCase}{CUR 14}{Consultar Doctor}
    {
    	Un paciente contara con la facultad de consultar los doctores que son o fueron responsables de sus tratamientos y asi poder tener un conocimiento de estos. 
...
%--------------------------------------------------------
 ...
 \begin{UCtrayectoria}
	 ...
	 \UCpaso [\UCactor] Presiona el icono \textbf{Consultar Doctores} en la pantalla \textbf{Gestión Doctor}.
	 ...
	 \UCpaso Muestra la pantalla \textbf{Consultar Doctor}. \label{acciones}
 ...
 \begin{UCtrayectoriaA}{A}{El actor no tiene doctores asociados a su cuenta.}
   	...
   	\UCpaso Muestra el mensaje \cdtIdRef{MSGX}{No hay Doctores} en la pantalla \textbf{Gestión Doctor}.
    
    \UCpaso [\UCactor] Presiona el botón \cdtButton{Agregar doctor} del mensaje {MSG}{No hay Doctores}. \refTray{B} 
    
    \UCpaso Extiende al caso de uso \cdtIdRef{CU12}{Agregar doctor}. \label{agregar}
...
\begin{UCtrayectoriaA}{B}{El actor no quiere agregar un doctor}
	...
	\UCpaso [\UCactor] Presiona el botón \cdtButton{Cancelar} del mensaje {MSG}{No hay Doctores}.
...
{\cdtIdRef{CUR 13}{Editar Doctor}}
 
 
\UCExtensionPoint
{El actor requiere eliminar un doctor}
{ Paso \ref{acciones} de la trayectoria principal}
{\cdtIdRef{CUR 14}{Eliminar Doctor}}
