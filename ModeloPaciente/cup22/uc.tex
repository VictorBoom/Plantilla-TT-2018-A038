\begin{UseCase}{CUR 22}{Editar Contactos de Emergencia}
    {
    ...
    \UCitem{Operación}{Editar Contacto de Emergencia}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Editar Contactos de Emergencia}
	\UCitem{Entradas}{
        \begin{UClist} 
	...
	\UCitem{Salidas}{\begin{UClist} 
			...
			\UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Contactos de Emergencia} cuando se editó el contacto de emergencia de manera exitosa.
	\end{UClist}}
	\UCitem{Precondiciones}{Ninguna.}
	\UCitem{Postcondiciones}{
	    {\bf Interna:} Editará los datos del contacto de emergencia en la aplicación.
	}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Edita la información que deseas editar en la pantalla \textbf{Editar Contacto de Emergencia}.
 ...
 \begin{UCtrayectoriaA}{B}{El actor no ingresó un dato requerido.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG}{Falta un dato requerido para efectuar la operaciónn solicitada} en la pantalla \textbf{Editar Contacto de Emergencia}.
 ...
 \begin{UCtrayectoriaA}{C}{El actor ingresó un correo electrónico y/o contraseña con un formato incorrecto.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG}{Correo electrónico y/o contraseña incorrecta} en la pantalla \textbf{Editar Contacto de Emergencia} indicando que el usuario y/o contraseña son incorrectos.
    \UCpaso[] Continúa con el paso 3 de la trayectoria principal.
 \end{UCtrayectoriaA} 
