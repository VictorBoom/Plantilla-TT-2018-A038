\begin{UseCase}{CUP25}{Editar Contacto de Emergencia}
    {
...
%--------------------------------------------------------
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Presiona el ícono \textbf{Editar Contacto de Emergencia} asociado al contacto de emergencia que desea editar en la pantalla \cdtIdRef{IUP26}{Consultar Contacto}.
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP25}{Editar Contacto}.
 ...
 \begin{UCtrayectoriaA}{B}{El actor no ingresó un dato requerido.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada} en la pantalla \textbf{Editar Contacto de Emergencia}.
 ...
 \begin{UCtrayectoriaA}{C}{El actor ingresó un correo electrónico y/o contraseña con un formato incorrecto.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecta} en la pantalla \textbf{Editar Contacto de Emergencia} indicando que el usuario y/o contraseña son incorrectos.
    \UCpaso[] Continúa con el paso \ref{info} de la trayectoria principal.
 \end{UCtrayectoriaA} 
