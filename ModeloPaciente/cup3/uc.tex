\begin{UseCase}{CUR 3}{Registro de cuenta}
    {
    	Cuando un usuario se quiere registrar en la aplicación seleccionara los roles a los cuales estará asociado y así se generaran las acciones con las que contara su perfil.
...
%--------------------------------------------------------
	...
	\UCitem{Entradas}{
        \begin{UClist} 
           ...
           \UCli \textbf{Rol del usuario}: Se selecciona de los checkbox
	...
	\UCitem{Errores}{
		...
		\UCli \cdtIdRef{MSG1}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \textbf{Crear cuenta} cuando el actor omitió un dato marcado como requerido.
