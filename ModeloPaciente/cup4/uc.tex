\begin{UseCase}{CUR 4}{Consultar datos personales}
    {
    	Un usuario podrá consultar sus tratamientos, doctores, auxiliares y su información personal para que tenga una vista de la información con la que cuenta. 
...
%--------------------------------------------------------
	...
	\UCitem{Salidas}{
		\begin{UClist}
			...
			\UCli Peso.
			\UCli Altura
			\UCli lista de Tratamientos activos.
			\UCli lista de Auxiliares.
			\UCli lista de Doctores.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso[\UCactor] Da click sobre el icono \textbf{Datos personales} de la pantalla \textbf{Menu principal}. \label{cur4:editar}
...
{ Paso \ref{cur4:editar} de la trayectoria principal}
