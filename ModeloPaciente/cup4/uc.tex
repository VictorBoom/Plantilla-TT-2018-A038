\begin{UseCase}{CUR 4}{Consultar Datos Personales}
    {

    	Un usuario necesita saber cual es su categoría, su información personal, los roles a los que pertenece y sus contactos de emergencia, de esta manera el tendrá un conocimiento de todos los datos que tiene asociados a su cuenta.
...
%--------------------------------------------------------
	...
	\UCitem{Errores}{
	    \begin{UClist}
	    \UCli \cdtIdRef{MSG8}{No se pudieron obtener los datos}: Se muestra en la pantalla \textbf{Menu principal} indicando que no se pudieron obtener los datos del usuario.
	    \end{UClist}
	}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso[\UCactor] Da click sobre el icono \textbf{Datos personales} de la pantalla \textbf{Menu principal}. \label{cur:ep}
 	\UCpaso Obtiene el nombre del usuario.\refTray{A}
 	\UCpaso Obtiene el rol al que esta asociado el usuario en ese momento.\refTray{A}
 	\UCpaso Obtiene la imagen del usuario.\refTray{A}
 	\UCpaso Obtiene la categoria del usuario.\refTray{A}
 	\UCpaso Obtiene los datos del usuario.\refTray{A}
 	\UCpaso Obtiene los roles del usuario a los que pertence.\refTray{A}
 	\UCpaso Obtiene el correo electronico del usuario.\refTray{A}
...
\begin{UCtrayectoriaA}{A}{El sistema no pudo obtener los datos requeridos.}
	\UCpaso Muestra el mensaje \cdtIdRef{MSG8}{No se pudieron obtener los datos} en la pantalla \textbf{Menu principal}
	
	\UCpaso[\UCsist] Muestra la pantalla \textbf{Menu principal}
