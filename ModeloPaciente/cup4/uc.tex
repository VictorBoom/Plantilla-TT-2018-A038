\begin{UseCase}{CUR 4}{Consultar datos personales}
    {
    	...
    	Un usuario contara con la facultad de consultar los datos con los que cuenta su perfil, como lo son,  información personal, tratamientos, doctores, auxiliares y demás.
...
%--------------------------------------------------------
	...
	\UCitem{Errores}{
	    \begin{UClist}
	    \UCli \cdtIdRef{MSG5}{No se pudieron obtener los datos}: Se muestra en la pantalla \textbf{Menu principal} indicando que no se pudieron obtener los datos del usuario.
	    \end{UClist}
	}
