\begin{UseCase}{CUR 23}{Consultar Contacto de Emergencia}
    {
    	...
    	Un contacto de emergencia es la persona a la cual se contactara cuando un \textbf{Paciente} no este realizando la toma de un medicamento que tenga una clasificación \textbf{Importante}, es por eso que un paciente podrá visualizar la información de los contactos de emergencia.
    }
    \UCitem{Versión}{1.0}
...
\begin{UCtrayectoria}
	...
	\UCpaso [\UCactor] Presiona el icono \textbf{Contactos de Emergencia} en la pantalla \textbf{Consultar Datos Personales}.
	...
	\UCpaso Obtiene el correo electronico de los contactos de emergencia.
