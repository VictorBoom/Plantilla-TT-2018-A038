...
%--------------------------------------------------------
 ...
 \begin{UCtrayectoriaA}{B}{El actor no desea agregar un nuevo tratamiento.}
    \UCpaso[\UCactor] Presiona el botón \cdtButton{Aceptar} del mensaje {MSG9}{No hay tratamientos}.
...
{\cdtIdRef{CUP8 }{Agregar Tratamiento}}
