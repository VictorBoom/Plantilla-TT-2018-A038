\begin{UseCase}{CUR 6}{Consultar Tratamiento}
    {
...
%--------------------------------------------------------
	...
	\UCitem{Salidas}{
		\begin{UClist}
			...
			\UCli Numero de medicamentos del tratamiento.
		\end{UClist}
	}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso Obtiene el nombre del doctor que expidio el tratamiento
 	
 	\UCpaso Obtiene la fecha de expedicion del tratamiento.
 	
 	\UCpaso Obtiene el estado del tratamiento.
 	
 	\UCpaso Obtiene el numero de medicamentos.
